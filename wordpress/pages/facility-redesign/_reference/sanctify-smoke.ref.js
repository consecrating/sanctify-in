...
function getTextureScale(texture,width,height){return{x:width/texture.width,y:height/texture.height}}}catch(e){}}['sf-smoke','sf-smoke2'].forEach(function(id){var c=document.getElementById(id);if(c){initSmoke(c)}})})()